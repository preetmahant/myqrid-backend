...
function leadActions() {
  return new Set(["whatsapp_click", "call_click", "save_contact", "copy_link"]);
}
...
function validateProfileInput(body) {
  ...
  return { value: { name, phone, whatsapp, email, bio, image_url: imageUrl, emergency_name: emergencyName, emergency_phone: emergencyPhone } };
}

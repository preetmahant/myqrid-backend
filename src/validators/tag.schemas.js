...
const tagType = z.enum(["personal", "business", "asset", "pet", "safety", "medical", "helmet", "luggage", "kid", "vehicle", "event", "creator", "employee", "enterprise"]);
...
const createTagSchema = z.object({
  body: z.object({
    ...
    tagType,
    tagSubtype: z.string().max(50).optional()
  })
});
...
module.exports = { createTagSchema, manufactureSchema };
